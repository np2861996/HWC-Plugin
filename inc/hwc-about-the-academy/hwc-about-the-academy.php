...
function hwc_create_about_the_academy_page_with_acf_fields()
{
    ...
    ----------------------------------------------------------------*/
    // Check if the About The Academy page creation has already been run
    $about_academy_created = get_option('hwc_about_academy_created');
    ...
    if (!$about_academy_created) {
        ...
        // Set the flag to indicate the About The Academy page was created
        update_option('hwc_about_academy_created', true);
    } else {
        // If the About The Academy page creation was already done, just get its ID
        $hwc_about_the_academy_page = get_page_by_path($hwc_about_the_academy_page_slug);
        if ($hwc_about_the_academy_page) {
            $hwc_about_the_academy_page_id = $hwc_about_the_academy_page->ID;
        }
    ...
    ----------------------------------------------------------------*/
    if (get_page_by_path($hwc_about_the_academy_page_slug)) {
